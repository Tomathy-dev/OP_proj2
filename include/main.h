...
struct main_data {
    ...
    char log_filename[255]; // log file name
    char statistics_filename[255]; // statistics file name
    int alarm_time; // alarm timing

	int current_ops; // counter of the current number of operations
};
